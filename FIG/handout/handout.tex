...
\title{\texttt{FIG} $::=$ \texttt{FIG} \textit{is good} $\mid$ \texttt{FIG}
  \textit{is great} $\mid$ \texttt{FIG} \textit{is god} \small
\\ ~ \\ \texttt{dotwani@haverford.edu | msoulanill@haverford.edu} \\ ~ \\ \today  }
\date{}
...
\item
  ...
  and each other on specific aspects of your project. These meetings will be
  8:00-8:30 Tuesday nights and 9:30-10:00 Thursday nights usually in the D.C.
  basement where we are right now.
