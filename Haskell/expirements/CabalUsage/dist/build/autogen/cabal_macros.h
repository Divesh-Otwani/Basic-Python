...
/* package CabalUsage-0.1.0.0 */
#define VERSION_CabalUsage "0.1.0.0"
#define MIN_VERSION_CabalUsage(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "CabalUsage-0.1.0.0"

#define CURRENT_PACKAGE_KEY "CabalUsage-0.1.0.0"
